...
#endif
#ifndef LV_ATTRIBUTE_IMG_BATTERY_HALF
#define LV_ATTRIBUTE_IMG_BATTERY_HALF
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BATTERY_HALF uint8_t battery_half_map[] = {
...
const lv_img_dsc_t battery_half = {
