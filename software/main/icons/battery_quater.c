...
#endif
#ifndef LV_ATTRIBUTE_IMG_BATTERY_QUATER
#define LV_ATTRIBUTE_IMG_BATTERY_QUATER
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BATTERY_QUATER uint8_t battery_quater_map[] = {
...
const lv_img_dsc_t battery_quater = {
