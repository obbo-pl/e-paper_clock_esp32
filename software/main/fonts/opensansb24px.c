...
#ifndef OPENSANSB24PX
#define OPENSANSB24PX 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2161, .adv_w = 164, .box_w = 8, .box_h = 8, .ofs_x = 1, .ofs_y = 9}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t opensansb24px = {
#else
lv_font_t opensansb24px = {
#endif
